 .386
        ...
        extern fullDenominator@0:near
        public a_arr, denomIndex, n3, n4
    .data
...
; Variables
        ...
        text_title     DB "7-01-IP-03-Baran", 0
...
; Numerator:
    finit
    mov eax, offset c_arr
    mov ebx, offset d_arr
    call firstHalfNumerator
    
    mov eax, offset b_arr
    mov ebx, offset n2

    push eax
    push ebx
    call secondHalfNumerator
...
; 1 proccess   2 * c - d
    ...
    ret
    firstHalfNumerator endp

; 2 proccess   sqrt(23 * b)
    secondHalfNumerator proc

    push ebp
    mov ebp, esp

    mov ebx, [ebp + 8] ; n2
    mov eax, [ebp + 12] ; b_arr
